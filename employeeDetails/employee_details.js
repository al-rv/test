...
// Function findEmployeeById to display employees' details based on ID
function findEmployeeById() {
    ...
    if (foundEmployee){
        ...
        document.getElementById('employeesDetails').innerHTML = 'no employees has been found for with this ID';
    }
}